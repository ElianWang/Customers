...
<script src=<%= request.getContextPath() + "/js/businessDeal/addChild.js" %> type="text/javascript"></script>
</head>
			...
			<form id="addForm" action="">
				...
				<table style="border-collapse: separate;border-spacing:10px;">
					...
					<tr>
						...
						<td>
							<input id="contact" name="contact" type="text" readonly="readonly" value="${business.contact}"/>
						</td>
					</tr>
					<tr>
						<td>

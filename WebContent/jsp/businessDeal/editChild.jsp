...
<script src=<%= request.getContextPath() + "/js/businessDeal/editChild.js" %> type="text/javascript"></script>
</head>
    ...
    <div id="center" data-options="region:'center'">
		...
		<div align="center">
			<form id="editForm" action="">
				...
				<input id="updateTime" name="updateTime" value="${business.updateTime}" type="hidden"/>
				<input name="beginTime" value="${business.beginTime}" type="hidden" />
				<table style="border-collapse: separate;border-spacing:10px;">
					...
					<tr>
						...
						<td class="left-td">
							<input id="serviceTarget" name="serviceTarget" readonly="readonly" value="${business.serviceTarget}"/>
						</td>
						<td>
							<label>联系方式：</label>
						</td>
						<td>
							<input id="contact" type="text" nam="contact" readonly="readonly" value="${business.contact}"/>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input id="applyMan" name="applyMan" type="text" value="${business.applyMan}" />
						</td>
					</tr>
					<tr >
						<td >

...
<script src=<%= request.getContextPath() + "/js/sysconfig/docParams.js" %> type="text/javascript"></script>
</head>
			...
			<form id="searchForm">
				...
				<table style="border-collapse: separate;border-spacing:10px;">
					<tr>
						...
						<td>
							<label clsss="span" for="logLevel">参数类型</label>
						</td>
						<td>
							<input id="paramType" name="paramType" class="easyui-combobox"/>
						</td>
						<td>

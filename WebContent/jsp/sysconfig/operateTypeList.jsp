...
<script src=<%= request.getContextPath() + "/js/sysconfig/operateTypeList.js" %> type="text/javascript"></script>
</head>
			...
			<form id="searchForm">
				...
				<table style="border-collapse: separate;border-spacing:10px;">
					<tr>
						...
						<td>
							<label clsss="span" for="logLevel">办理状态</label>
						</td>
						<td>
							<input id="status" name="status" class="inputArea"/>
						</td>
						<td>

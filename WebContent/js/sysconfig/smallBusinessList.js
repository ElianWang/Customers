$(document).ready(function(){
	$("#bigBusiness").combobox({
	    ...
	    onLoadSuccess:function(){
	    	var data = $("#bigBusiness").combobox("getData");
	    	var bigBusiness = {};
	    	for(i in data){
	    		bigBusiness[data[i].id] = data[i].name;
	    	}
	...
	$("#edit_button").bind("click",function(){
		...
		var id = selects["id"];
		createWithoutCancle("编辑" + paramName,"/HR/params/editParam?id=" + id + "&paramType=" + paramType,330,180);
	});
